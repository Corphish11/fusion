    ...
    def track_videofile(self, videofilepath, optional_box=None):
        ...
        if optional_box is not None:
            ...
            while True:
                ...
                # init_state = [x, y, w, h]
                # net1 init_state = [983.3956, 322.54126, 1070.6053-983.3956, 537.21344-322.54126]
                # net2 init_state = [865.875, 426.37213, 939.6203-865.875, 620.0619-426.37213]
                # net3 init_state = [1023.3647, 326.01447, 1088.3893-1023.3647, 538.12994-326.01447]
                init_state = [864.4575, 428.44397, 923.0299-864.4575, 615.26556-428.44397]
        ...
        while True:
            ...
            my_i += 1
            if frame is None:
                with open("track_person_net4.json", 'w') as f:
                    json.dump(track_result_person, f)
                return
            ...
            track_result_person.update({my_i:state})
