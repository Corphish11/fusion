...
def parameters():
    ...
    params.max_image_sample_size = 500**2   # Maximum image sample size
    params.min_image_sample_size = 400**2   # Minimum image sample size
    params.search_area_scale = 6          # Scale relative to target size
