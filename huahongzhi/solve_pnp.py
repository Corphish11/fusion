...
def DLT():
    #论文标定点世界坐标
    xyz = [[0, 900, 0], [900, 900, 0], [0, 300, 0], [900, 300, 0], [0, 0, 0], [900, 0, 0], [0, -300, 0], [900, -300, 0], [0, -900, 0], [900, -900, 0], [0, 0, 224], [900, 0, 224], [0, 0, 124], [900, 0, 124]]
    #前端需求标定点世界坐标
    # xyz =  [[0,0,0],[0,900,0],[600,0,0],[600,900,0],[900,0,0],[900,900,0],[1200,0,0],[1200,900,0],[1800,0,0],[1800,900,0],[900,0,224],[900,900,224],[900,0,124],[900,900,124]]
    #前镜头标定点2d坐标
    uv1 = [[86, 795], [1817, 795], [381, 578], [1533, 578], [464, 515], [1451, 515], [527, 471], [1388, 471], [615, 408], [1298, 408], [461, 270], [1452, 270], [461, 375], [1452, 375]]
    #后镜头标定点2d坐标
    uv2 = [[1312, 522], [661, 522], [1394, 582], [572, 582], [1451, 625], [510, 625], [1527, 683], [429, 683], [1790, 885], [144, 885], [1453, 389], [510, 389], [1453, 487], [510, 487]]
    nd = 3
    L1, err = DLTcalib(nd, xyz, uv1)
    L2, err = DLTcalib(nd, xyz, uv2)
    L12 = [L1,L2]
    return L1, L2
