...
def performDetect(imagePath="3.jpg", thresh=0.5, configPath="./backup/yolov3-tiny-demo.cfg",
                  weightPath="./backup/yolov3-tiny-demo_final.weights", metaPath="./backup/data/obj.data", showImage=True,
...
def my_performDetect(imagePath="1.jpg", thresh=0.5, configPath="./zhaoyu/yolov3-tiny-demo.cfg",
                     weightPath="./zhaoyu/backup/yolov3-tiny-demo_1200.weights", metaPath="./data/obj.data", showImage=True,
                     makeImageOnly=False, initOnly=False):
    """
    Convenience function to handle the detection and returns of objects.
...
def get_coor(netMain, metaMain, imagePath, thresh, showImage=True, makeImageOnly=False):
    if not os.path.exists(imagePath):
        raise ValueError("Invalid image path `" + os.path.abspath(imagePath) + "`")
    detections = detect(netMain, metaMain, imagePath.encode("ascii"), thresh)
    if showImage:
...
if __name__ == "__main__":
    print(performDetect())
# darknet detector demo ./data/obj.data  yolov3-tiny-demo.cfg ./backup/yolov3-tiny-demo_1200.weights ../video/pos1.mp4 -i=0 -thresh 0.25
